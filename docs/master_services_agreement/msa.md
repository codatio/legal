---
title: Codat Master Services Agreement
description: Version 3.0, March 2024
sidebar_label: Master Services Agreement
sidebar_position: 1
...
**Fees**: the fees for use of the Codat Product(s), as set out in the relevant Order Form, including without limitation the Platform Fee, Unit Fees and Service Fees.
...
**Service Fees**: where relevant, the fees payable by the Client for the Codat Services, as set out in the relevant Statement of Work.

**Service Levels**: the periods of uptime set out in paragraph 2 of Schedule 1.

**Support Tier**: the response time service levels to Client support tickets, as set out in the Order Form and as further described at: Schedule 3.

**Unit Fees**: the fee payable by the Client per active Company, per month. 
...
Client may contact Codat with technical or other questions with respect to the Codat Product and/or Codat Services and to report Codat Product outages or failures, by emailing details of the issue to support@codat.io. Codat will provide a representative or help desk to answer technical support and other questions from the Client and its Authorised Users, in accordance with the response times specific to the Support Tier described on the relevant Order Form. Client acknowledges and agrees that the Client shall be responsible for providing first level support to Companies provided that the Client will be entitled to raise issues with Codat which are unable to be resolved by the Client. The Client acknowledges that Codat Support is provided from UK, US and Australian Support teams and that Company Data may be accessed by any location for the purpose of providing Support in accordance with this section. 
...
In the event this Agreement is renewed in accordance with clause 7.1 (below), Codat may, increase the Platform Fee and the Unit Fees on an annual basis with effect from each anniversary of the Initial Order Start Date in line with the percentage increase in the Consumer Prices Index in the preceding 12-month period. The increase shall take effect at the beginning of the first day of the relevant Renewal Term and shall be based on the latest available figure for the percentage increase in the Consumer Prices Index at the beginning of the last month of the previous Initial Term or Renewal Term (as relevant).

### 5.3 Invoicing

Codat shall invoice the Client in advance for the Platform Fees, either annually or in accordance with the applicable Order Form, if different. Unit Fees  shall be invoiced to the Client monthly in arrears. Service Fees (if relevant) shall be invoiced to Client as set out in the SOW. Unless otherwise stated in the Order Form or Statement of Work, the first invoice in relation to an Order Form or Statement of Work will be due on receipt, with subsequent invoices due net 30 days from the invoice date.
...
Where Codat is a Controller in relation to personal data under this Agreement, Codat may use Personal Data in the manner set out in Codat’s Privacy Notice and as further set out in this Agreement.
...
| USA                                           | Codat Inc, a company incorporated in Delaware with its principle place of business being 57 E 11th St 7th Floor, New York, NY 10010        | The laws of Delaware | The courts of New York, New York   | A day on which the Federal Reserve Bank of New York is open for business.   
